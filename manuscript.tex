...
It is shown that the Wigner--Yanase skew information at temperature is equal to the doubled second moment of the MQ NMR spectra at the temperature twice large and any evolution times.
...
MQ NMR coherences are created by a periodic multipulse sequence, consisting of $I_x$-pulses, irradiating the system of the preparation period~\cite{9}.
...
If the spin system is investigated with MQ NMR at temperature $T\sim\beta^{-1}$ then the Wigner--Yanase skew information equals to the doubled second momentum of the distribution of the intensities of the MQ NMR coherences at temperature $2T \sim 2\beta^{-1}$ at any moment of the spin evolution.
...
We compare these information the following Section~\ref{sec:4}.
...
\begin{figure}
	...
	\caption{
		...
		open circles - results are obtained with the Wigner--Yanase information.
	}
	\label{fig:2}
\end{figure}
...
\end{equation}
%
The restrictions (22) allow us to hope that the obtained results of the number of entangled spins are not strong by different.
