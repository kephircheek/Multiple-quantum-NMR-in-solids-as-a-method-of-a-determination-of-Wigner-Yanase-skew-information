...
\begin{figure}
	...
	\caption{
		The dependence of the number $N_\mathrm{ent}$ of the entangled spins on the parameter $\beta$ (the inverse temperature) for zigzag chains consisting of six spins.
	}
	\label{fig:3}
\end{figure}
